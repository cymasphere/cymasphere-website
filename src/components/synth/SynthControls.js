...
const SynthControls = ({ selectedSynth, synth, effectsChain, updateSynthParam, updateEffectParam }) => {
  ...
  useEffect(() => {
    ...
    if (synth && selectedSynth === 'polysynth') {
      ...
      try {
        const vol = synth.volume && typeof synth.volume.value !== 'undefined' 
          ? synth.volume.value 
          : -15;
  ...
  }, [synth, selectedSynth, effectsChain]);
            ...
            <>
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('polyVolume', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('polyDetune', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('polyAttack', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('polyDecay', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('polySustain', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('polyRelease', e.target.value)}
                />
              </ControlGroup>
            </>
          )}
            ...
            <>
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('fmVolume', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('fmModulationIndex', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('fmHarmonicity', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('fmAttack', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('fmDecay', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('fmSustain', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('fmRelease', e.target.value)}
                />
              </ControlGroup>
            </>
          )}
            ...
            <>
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('padVolume', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('padDetune', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('padFilterFreq', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('padAttack', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('padDecay', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('padSustain', e.target.value)}
                />
              </ControlGroup>
              ...
              <ControlGroup>
                ...
                <Slider 
                  ...
                  onChange={(e) => handleSynthParamChange('padRelease', e.target.value)}
                />
              </ControlGroup>
            </>
          )}
        ...
        >
          ...
          <ControlGroup>
            ...
            <Slider 
              ...
              onChange={(e) => handleEffectParamChange('masterVolume', 'volume', e.target.value)}
            />
          </ControlGroup>
          ...
          <ControlGroup>
            ...
            <Slider 
              ...
              onChange={(e) => handleEffectParamChange('reverb', 'Decay', e.target.value)}
            />
          </ControlGroup>
          ...
          <ControlGroup>
            ...
            <Slider 
              ...
              onChange={(e) => handleEffectParamChange('reverb', 'PreDelay', e.target.value)}
            />
          </ControlGroup>
          
          <ControlGroup>
            <ControlLabel>
              Reverb Mix <span>{Math.round(effectParams.reverbWet * 100)}%</span>
            </ControlLabel>
            <Slider 
              type="range" 
              min="0" 
              ...
              onChange={(e) => handleEffectParamChange('reverb', 'Wet', e.target.value)}
            />
          </ControlGroup>
          ...
          <ControlGroup>
            ...
            <Slider 
              ...
              onChange={(e) => handleEffectParamChange('delay', 'Time', e.target.value)}
            />
          </ControlGroup>
          
          <ControlGroup>
            <ControlLabel>
              Delay Feedback <span>{Math.round(effectParams.delayFeedback * 100)}%</span>
            </ControlLabel>
            <Slider 
              type="range" 
              min="0" 
              ...
              onChange={(e) => handleEffectParamChange('delay', 'Feedback', e.target.value)}
            />
          </ControlGroup>
          ...
          <ControlGroup>
            ...
            <Slider 
              ...
              onChange={(e) => handleEffectParamChange('delay', 'Wet', e.target.value)}
            />
          </ControlGroup>
          ...
          <ControlGroup>
            ...
            <Slider 
              ...
              onChange={(e) => handleEffectParamChange('chorus', 'Frequency', e.target.value)}
            />
          </ControlGroup>
          
          <ControlGroup>
            <ControlLabel>
              Chorus Depth <span>{Math.round(effectParams.chorusDepth * 100)}%</span>
            </ControlLabel>
            <Slider 
              type="range" 
              min="0" 
              ...
              onChange={(e) => handleEffectParamChange('chorus', 'Depth', e.target.value)}
            />
          </ControlGroup>
          
          <ControlGroup>
            <ControlLabel>
              Chorus Mix <span>{Math.round(effectParams.chorusWet * 100)}%</span>
            </ControlLabel>
            <Slider 
              type="range" 
              min="0" 
              ...
              onChange={(e) => handleEffectParamChange('chorus', 'Wet', e.target.value)}
            />
          </ControlGroup>
          ...
          <ControlGroup>
            <ControlLabel>
              Stereo Width <span>{Math.round(effectParams.stereoWidth * 100)}%</span>
            </ControlLabel>
            <Slider 
              type="range" 
              min="0" 
              ...
              onChange={(e) => handleEffectParamChange('stereoWidener', 'Width', e.target.value)}
            />
          </ControlGroup>
        </ControlsPanel>
      )}
