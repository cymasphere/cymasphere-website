...
const Timeline = ({ onTimelineUpdate, availableChords, isPlaying, currentSlotIndex, initialSlots }) => {
        ...
        {slots.map((slot, index) => (
          <div 
            ...
            style={{
              ...
              userSelect: 'none',
              border: isPlaying && currentSlotIndex === index 
                ? '3px solid rgba(255, 255, 255, 0.9)' 
                : slot 
                  ? '2px solid rgba(255, 255, 255, 0.2)'
                  : '2px dashed rgba(255, 255, 255, 0.3)',
              boxShadow: isPlaying && currentSlotIndex === index 
