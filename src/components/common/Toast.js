...
const ToastContainer = styled.div`
  ...
  &:before {
    ...
    background: ${props => {
      switch(props.$type) {
        case 'success': return 'linear-gradient(90deg, #4ECDC4, #2ecc71)';
        case 'error': return 'linear-gradient(90deg, #FF6B6B, #ee5253)';
        case 'warning': return 'linear-gradient(90deg, #FFD166, #F7B731)';
        default: return 'linear-gradient(90deg, #6C63FF, #4ECDC4)';
      }
    }};
