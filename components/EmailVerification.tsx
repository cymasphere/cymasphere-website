...
function EmailVerification() {
  ...
  const handleResendEmail = async () => {
    ...
    try {
      if (!verifyEmail) {
        throw new Error(
          "Email verification is not initialized. Please try again later."
        );
      }
    ...
    <PageContainer>
      ...
      >
        <VerificationContent>
          ...
          <VerificationText>
            Please verify <EmailHighlight>{user.email}</EmailHighlight> to
            access your dashboard. Check your inbox for a verification link.
          </VerificationText>
      ...
      >
        <BannerContent>
          ...
          <MessageContainer>
            ...
            <Message>
              We sent a verification email to {user.email}. Please check your
      ...
      <ButtonGroup>
        ...
        <Link href="/dashboard" passHref>
          <LinkButton>Continue to Dashboard</LinkButton>
        </Link>
      </ButtonGroup>
    </PageContainer>
  );
