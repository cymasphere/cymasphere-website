...
<!-- FeedbackReportingGuide.tsx -->
# Feedback Reporting Guide

<>

## Bug Reports, Feature Requests & Crash Reports

 Use the Profile menu (avatar, top right) to open **Bug Report** or
 **Feature Request**. Both open the same report form with different defaults. You can also file
 from your account on the website at
 cymasphere.com/bug-report and
 cymasphere.com/feature-request , or browse tickets under
 Support .

### Bug Report

 Describe steps to reproduce, expected vs actual behavior, your OS, and the app version from About. In the
 standalone and plugin apps, Bug Report can attach a compressed copy of your song database to help diagnosis.

### Feature Request

 Describe the workflow you want and why it would help. Feature requests do not auto-attach your database.

### After a Crash

 If Cymasphere closed unexpectedly, the next launch can show a send-report prompt — the same report UI as Bug
 Report, preloaded with stack and session data when available. You can add a short description of what you were
 doing, then Send Report or dismiss.
